"""Trial 017: trial_015 기반 개선
- feature_w/x/y/z 제외 (test 38% NaN)
- num_boost_round=2000 (016에서 1000라운드도 부족했음)
- sub_category×horizon + horizon 통계만 (sub_code stats → test 81% NaN으로 버림)
...
def main():
    ...
    save_submission(test, model_full.predict(X_te), 'trial_017_tuned',
