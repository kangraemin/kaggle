"""Trial 019: trial_019 기반, num_leaves 255→511
- num_leaves=511 (모델 표현력 강화)
- feature_ay/cd 추가 제외 (test 5.8% NaN)
...
def main():
    ...
    save_submission(test, model_full.predict(X_te), 'trial_019_tuned',
