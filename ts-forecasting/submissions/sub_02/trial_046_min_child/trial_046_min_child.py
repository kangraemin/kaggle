"""Trial 046: min_child_samples 20→10
- lr 0.05→0.03, rounds 3000→5000
- lambda_l1=0.1, lambda_l2=0.1 (overfitting 방지)
- trial_046(0.4873) 기반
"""
import gc
import sys
...
def main():
    ...
    save_submission(test, preds, 'trial_046_ts_val_improved',
