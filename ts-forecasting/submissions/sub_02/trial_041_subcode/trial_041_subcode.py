"""Trial 041: sub_code level stats 추가
- sub_code 25.5% 커버 → 겹치는 unknown series에 추가 signal
- cold-start 10% (trial_040 방식 유지)
- trial_040(0.4570) 기반
"""
import gc
import sys
...
def main():
    ...
    save_submission(test, preds, 'trial_041_ts_val_improved',
