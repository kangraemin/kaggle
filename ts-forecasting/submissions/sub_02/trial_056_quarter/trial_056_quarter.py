...
def main():
    ...
    # weight^0.25 변환
    train['weight'] = train['weight'] ** 0.25
    print(f"Weight^0.25: max={train['weight'].max():.2e}")
    ...
    save_submission(test, preds, 'trial_056_ts_val_improved',
