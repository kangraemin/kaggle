"""Trial 038: full feature set
- lag 1~5, 10, 20 + rolling_mean/std 5/10 + ewm_5 + trend features
- code_mean/subcat_mean (unknown series용, danger 패치로 안전)
- trial_038(0.4065) 기반 확장
"""
import gc
import sys
import psutil
...
def main():
    ...
    save_submission(test, preds, 'trial_038_ts_val_improved',
