"""Trial 055: log(1+weight) 변환
- sqrt보다 더 aggressive한 압축
- trial_055(0.5227) 기반
"""
import gc
import sys
...
def main():
    ...
    # log(1+weight) 변환
    train['weight'] = np.log1p(train['weight'])
    print(f"Weight log1p: max={train['weight'].max():.2e}")
    ...
    save_submission(test, preds, 'trial_055_ts_val_improved',
