"""Trial 034: known series에 더 많은 시계열 features
- last_y_1, last_y_2, last_y_3 (lag 1~3)
- series_mean, series_std (known series 시계열 통계)
- trial_034 val 0.2054 → 더 개선 시도
- 모두 클리핑 적용
"""
import gc
import sys
...
def main():
    ...
    save_submission(test, preds, 'trial_034_ts_val_improved',
