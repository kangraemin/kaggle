...
| 053 | pmix_4fold_blend | **45** | - | 채점중 | pseudo-mix 컴포넌트 fold0+fold1 2-fold → fold0..3 4-fold 앙상블 확장 (dataset v3). weight·다른 컴포넌트·prior_mask 모두 trial_052 고정 (Perch 72%). 코드 변경 0 (loader가 best_fold*.pth glob+mean). kernel v40. submission mean 0.0396 | 🔄 ralph it.3(재개), 채점중 |
