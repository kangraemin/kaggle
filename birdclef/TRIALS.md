...
| 064 | effnet_weight_up | **56** | - | PENDING | ralph it.14. trial_063 역효과(-0.001) 분석: mwf0 noisy 가설 기각, pmix 방향 소진 확인. EffNet 슬롯 증량 테스트: BLEND_EFFNET 0.15→0.17 (+2pp), Perch 0.72→0.70 (-2pp). mwf0 0.02 원복, pmix 0.11 원복 (trial_062 state 복원). 가설: EffNet 5-fold(가장 검증된 보조 컴포넌트)의 비중 확대가 Perch 단독 의존도를 줄여 0.934 천장 돌파. kernel v51 push 완료. | PENDING |
