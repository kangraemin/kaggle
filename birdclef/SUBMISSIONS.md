...
| 53 | 2026-05-13 | trial_061 | ConvNeXt 컴포넌트 fold0 single → fold0..4 5-fold 평균 (BLEND_CONVNEXT=0.03 그대로, Perch 72%·EffNet5fold 15%·mwf0 2%·pmix 8%·distill 0% 전부 trial_060 동일, kernel v48) | PENDING | 🔄 ralph it.11. pmix 2→4-fold(+0.001) 패턴 모방 + trial_060 timeout 복구. 5-fold avg가 single-fold noise 넘어 ConvNeXt 신호 잡으면 +0.001, 아니면 backbone-family 축 closure |
