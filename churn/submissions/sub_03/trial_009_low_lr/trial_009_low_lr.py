...
OUT_DIR  = "/Users/ram/programming/vibecoding/kaggle/churn/submissions/sub_03/trial_009_low_lr"
...
for fold, (tr_idx, val_idx) in enumerate(skf.split(train[num_cols], y)):
    ...
    model = lgb.LGBMClassifier(**params, n_estimators=5000)  # 1000 → 5000
...
sub.to_csv(f"{OUT_DIR}/trial_009_low_lr.csv", index=False)

results = {
    "id": "009", "status": "done", "val_score": round(oof_auc, 5),
    "notes": "lr=0.01, n_estimators=5000, early_stopping=100",
    "conclusion": ""
}
