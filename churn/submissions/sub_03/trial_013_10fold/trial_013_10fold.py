...
OUT_DIR  = f"{DATA_DIR}/submissions/sub_03/trial_013_10fold"
...
pd.DataFrame({"id":test["id"],"Churn":test_preds}).to_csv(f"{OUT_DIR}/trial_013_10fold.csv",index=False)
json.dump({"id":"013","status":"done","val_score":round(oof_auc,5),
           "notes":"10-Fold + No internet→No + Contract_ord"},
