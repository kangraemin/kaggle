...
OUT_DIR  = f"{DATA_DIR}/submissions/sub_07/trial_037_lgbm_reg5"
...
pd.DataFrame({"id":test["id"],"Churn":all_test}).to_csv(f"{OUT_DIR}/trial_037_lgbm_reg5.csv",index=False)
json.dump({"id":"037","status":"done","val_score":round(oof_auc,5),
