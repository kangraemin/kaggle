...
OUT_DIR  = f"{DATA_DIR}/submissions/sub_07/trial_044_histgbm"
...
pd.DataFrame({"id":test["id"],"Churn":all_test}).to_csv(f"{OUT_DIR}/trial_044_histgbm.csv",index=False)
json.dump({"id":"044","status":"done","val_score":round(oof_auc,5),
           "notes":"HistGradientBoosting l2=5.0 + smoothed TE + 7seeds"},
